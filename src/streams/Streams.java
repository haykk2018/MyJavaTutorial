...
public class Streams {
    public static void main(String[] args) {
        ...
        courses.stream()  // obtaining the stream
                ...
                .forEach(out::println); // the final operation that prints each element
        ...
        long numberOfUniqueElements = numbers.stream()// 1 1 4 8 3 7 5 4 3
                .distinct()
                .peek(out::println) // 1 4 8 3 7 5
                .count();

        out.println("Result: " + numberOfUniqueElements); // Result: 6
        ...
        out.println("--takeWhile and dropWhile--");

        Stream.of(10, 13, 11, 7, 0, 5, 8, 11)
                .takeWhile(n -> n > 0)
                .forEach(out::println); // 10 13 11 7
        Stream.of(10, 13, 11, 7, 0, 5, 8, 11)
                .dropWhile(n -> n > 0)
                .forEach(out::println); // 0 5 8 11
